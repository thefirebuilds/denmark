...
ALTER TABLE IF EXISTS ONLY public.vehicle_aliases DROP CONSTRAINT IF EXISTS vehicle_aliases_vehicle_id_fkey;
...
DROP INDEX IF EXISTS public.idx_vehicle_aliases_alias;
DROP INDEX IF EXISTS public.idx_vehicle_aliases_vehicle_id;
DROP INDEX IF EXISTS public.idx_vehicle_aliases_lookup;
DROP INDEX IF EXISTS public.idx_vehicle_aliases_vehicle_alias;
...
DROP TABLE IF EXISTS public.vehicle_aliases;
...
CREATE TABLE public.trip_financial_facts (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.metric_period_snapshots (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.vehicle_period_snapshots (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE public.metric_data_quality_flags (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    confidence_penalty numeric(6,4) DEFAULT 0 NOT NULL,
    note text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    resolved_at timestamp with time zone
);

CREATE TABLE public.ai_metric_reviews (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    period_key text NOT NULL,
    snapshot_id bigint,
    review_kind text DEFAULT 'quarterly'::text NOT NULL,
    model text,
    prompt_version text,
...
--
-- Name: vehicle_fmv_estimates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.vehicle_fmv_estimates (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    vehicle_vin text NOT NULL,
    estimated_at timestamp with time zone DEFAULT now() NOT NULL,
    estimate_source text DEFAULT 'openai'::text NOT NULL,
    ...
    confidence text,
    rationale text,
    major_risks jsonb DEFAULT '[]'::jsonb NOT NULL,
...
CREATE TABLE public.expenses (
    ...
    CONSTRAINT expenses_expense_scope_check CHECK (((expense_scope)::text = ANY (ARRAY[('direct'::character varying)::text, ('general'::character varying)::text, ('shared'::character varying)::text, ('apportioned'::character varying)::text])))
);
...
CREATE TABLE public.trips (
    ...
    return_late_minutes integer,
    return_detection_source text,
    return_detected_location text,
    return_distance_miles numeric,
    notes text,
...
--
-- Name: vehicle_aliases; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: vehicle_aliases vehicle_aliases_vehicle_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vehicle_aliases
    ADD CONSTRAINT vehicle_aliases_vehicle_id_fkey FOREIGN KEY (vehicle_id) REFERENCES public.vehicles(id) ON DELETE CASCADE;
...
-- Name: idx_vehicle_aliases_alias; Type: INDEX; Schema: public; Owner: -
CREATE UNIQUE INDEX idx_vehicle_aliases_alias ON public.vehicle_aliases USING btree (lower(trim(alias))) WHERE (active = true);

-- Name: idx_vehicle_aliases_vehicle_id; Type: INDEX; Schema: public; Owner: -
CREATE INDEX idx_vehicle_aliases_vehicle_id ON public.vehicle_aliases USING btree (vehicle_id);
...
--
-- Name: idx_vehicle_fmv_estimates_snapshot_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vehicle_fmv_estimates_snapshot_hash ON public.vehicle_fmv_estimates USING btree (snapshot_hash);


--
-- Name: idx_vehicle_fmv_estimates_vehicle_vin_estimated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vehicle_fmv_estimates_vehicle_vin_estimated_at ON public.vehicle_fmv_estimates USING btree (vehicle_vin, estimated_at DESC);
...
--
-- Name: vehicle_fmv_estimates vehicle_fmv_estimates_vehicle_vin_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vehicle_fmv_estimates
    ADD CONSTRAINT vehicle_fmv_estimates_vehicle_vin_fkey FOREIGN KEY (vehicle_vin) REFERENCES public.vehicles(vin) ON DELETE CASCADE;
