    ...
    ensureMessageRuntimeSchemaPromise = client
      .query(`
        ALTER TABLE IF EXISTS public.messages
          ...
          ADD COLUMN IF NOT EXISTS from_header text,
          ...
          ADD COLUMN IF NOT EXISTS content_type_header text,
          ADD COLUMN IF NOT EXISTS flags text[],
          ADD COLUMN IF NOT EXISTS message_type text,
          ADD COLUMN IF NOT EXISTS amount numeric(10,2),
          ADD COLUMN IF NOT EXISTS guest_name text,
          ADD COLUMN IF NOT EXISTS guest_phone text,
          ADD COLUMN IF NOT EXISTS guest_profile_url text,
          ADD COLUMN IF NOT EXISTS vehicle_name text,
          ADD COLUMN IF NOT EXISTS vehicle_year integer,
          ADD COLUMN IF NOT EXISTS vehicle_listing_url text,
          ADD COLUMN IF NOT EXISTS vehicle_listing_id bigint,
          ...
          ADD COLUMN IF NOT EXISTS mileage_included integer,
          ...
          ADD COLUMN IF NOT EXISTS raw_source bytea,
